        ...
        auth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful() && auth != null && auth.getCurrentUser() != null){
                            Toast.makeText(LoginActivity.this, String.format("%s is logged in", auth.getCurrentUser().getDisplayName()),
